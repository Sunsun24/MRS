...
void AC_AttitudeControl_Sub::rate_controller_run()
{
    ...
    _motors.set_roll(get_rate_roll_pid().update_all(_ang_vel_body.x, gyro_latest.x, _dt, _motors.limit.roll) + get_rate_roll_pid().get_adaptive_term(1)); //***
    _motors.set_pitch(get_rate_pitch_pid().update_all(_ang_vel_body.y, gyro_latest.y, _dt, _motors.limit.pitch) + get_rate_pitch_pid().get_adaptive_term(1)); //***
    _motors.set_yaw(get_rate_yaw_pid().update_all(_ang_vel_body.z, gyro_latest.z, _dt, _motors.limit.yaw) + get_rate_yaw_pid().get_adaptive_term(1));  //***
