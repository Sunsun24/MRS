...
//*****************************
	...
	float _update_adaptive_robust_rule(float pid, float error, float error_dot, float error_int);
	float get_adaptive_term(float scaler);
	float get_error();
	...
	float _intK0 = 0.00001;
	float _intK1 = 0.00001;
	float _intK2 = 0.00001;
    float _intK3 = 0.00001;
//*****************************
