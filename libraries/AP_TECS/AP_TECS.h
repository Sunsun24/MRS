...
//**************************
	...
	float _update_throttle_adaptive_robust_rule(float pid_sum, float FF, float error, float error_dot, float error_int);

	// Get pitch adaptive robust rule term  **********************
	float _update_pitch_adaptive_robust_rule(float pid_sum, float FF ,float error, float error_dot, float error_int);
